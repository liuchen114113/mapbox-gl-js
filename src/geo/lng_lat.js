 ...
 *
 * Curvemap GL uses longitude, latitude coordinate order (as opposed to latitude, longitude) to match GeoJSON.
 *
 * Note that any Curvemap GL method that accepts a `LngLat` object as an argument or option
 ...
 * @example
 * var ll = new curvemapgl.LngLat(-73.9749, 40.7736);
...
class LngLat {
     ...
     * @example
     * var ll = new curvemapgl.LngLat(286.0251, 40.7736);
     * var wrapped = ll.wrap();
     * wrapped.lng; // = -73.9749
     */
    wrap() {
     ...
     * var ll = curvemapgl.LngLat.convert(arr);
 ...
 * @example
 * var v1 = new curvemapgl.LngLat(-122.420679, 37.772537);
