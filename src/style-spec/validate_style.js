...
import jsonlint from '@hymap/jsonlint-lines-primitives';
import {v8} from './style-spec';

/**
 * Validate a Curvemap GL style against the style specification.
 *
 * @private
 * @alias validate
 ...
 * @example
 *   var validate = require('curvemap-gl-style-spec').validate;
