            ...
            <div id='quickstart-cdn'>
                ...
                <Copyable>
                    {highlightMarkup(`
                        ...
                        <script>
                        curvemapgl.accessToken = '${this.props.token}';
    ...
    render() {
        return (
            <div id='quickstart-bundler'>
                ...
                {highlightShell(`npm install --save curvemap-gl`)}
                ...
                <Copyable>
                    {highlightJavascript(`
                        import curvemapgl from 'curvemap-gl';
                        // or "const curvemapgl = require('curvemap-gl');"

                        curvemapgl.accessToken = '${this.props.token}';
                        const map = new curvemapgl.Map({
    ...
    render() {
        return (
            <section className='pad4 contain'>
                <h1 className=''>Curvemap GL JS</h1>
                <div className='pad1y quiet small'>Current version:
                    <span className='round fill-light pad0'><a href='https://github.com/curvemap/curvemap-gl-js/releases'>curvemap-gl.js v{version}</a></span>
                </div>
                <div className='prose space-bottom2'>
                    <p className='space-bottom2 pad1y'>Curvemap GL JS is a JavaScript library that uses WebGL to render interactive maps
                        from <a href='https://www.curvemap.com/help/define-vector-tiles'>vector tiles</a> and <a
                            href={prefixUrl('/style-spec')}>Curvemap styles</a>.
                        It is part of the Curvemap GL ecosystem, which includes <a
                            href='https://www.curvemap.com/mobile/'>Curvemap Mobile</a>, a compatible renderer written in C++ with bindings
                    ...
                    <div className='col12 fill-light round pad2 clearfix space-top2'>
                        <div className='space-bottom2 space-left1 space-top1 contain'>
                            ...
                            <div className='pin-left pad0x space-left4'>
                                <a className='block line-height15' href='https://github.com/curvemap/curvemap-gl-js'>Project on Github</a>
                        ...
                        <div className='space-bottom2 space-left1 contain'>
                            ...
                            <div className='pin-left pad0x space-left4'>
                                <a className='block line-height15' href='https://www.curvemap.com/help/curvemap-gl-js-fundamentals/'>GL JS
                                    Fundamentals</a>
                        ...
                        <div className='contain space-left1'>
                            ...
                            <div className='pin-left pad0x space-left4'>
                                <a className='block line-height15' href='https://www.curvemap.com/gallery/'>Gallery</a>
                    ...
                    <div className='space-bottom1'>To get started, you need to obtain an <a
                        href='https://www.curvemap.com/help/create-api-access-token/'>access token</a> and a <a
                        href='https://www.curvemap.com/help/define-style-url/'>style URL</a>. You can choose from one of our <a
                        href='https://www.curvemap.com/api-documentation/#styles'>professionally designed styles</a> or create
                        your own using <a href="https://www.curvemap.com/studio">Curvemap Studio</a>.
                    </div>

                    <div className='rounded-toggle space-bottom2 inline'>
                        <a onClick={() => this.setState({tab: 'cdn'})}
                            className={this.state.tab === 'cdn' ? 'active' : ''}>Curvemap CDN</a>
                    ...
                    <div>
                        ...
                        <p>As a mitigation for Cross-Site Scripting and other types of web security vulnerabilities, you may use
                            ...
                            specify security policies for your website. If you do, Curvemap GL JS requires the following CSP
                            directives:</p>
                        <pre><code>{`worker-src blob: ;\nchild-src blob: ;\nimg-src data: blob: ;`}</code></pre>

                        <p>Requesting styles from Curvemap or other services will require additional
                            directives. For Curvemap, you can use this <code>connect-src</code> directive:</p>
                        <pre><code>{`connect-src https://*.tiles.curvemap.com https://api.curvemap.com`}</code></pre>
                    </div>
                </div>
            </section>
        );
